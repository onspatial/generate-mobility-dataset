...
You can use the source code in [map_creation](src/main/python/map_creation) to create map programmatically or follow the instructions below to create a map manually.
