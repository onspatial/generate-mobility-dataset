...
You can use the source code in [maps.py](src/main/python/code/maps.py) to create map programmatically or follow the instructions below to create a map manually.
